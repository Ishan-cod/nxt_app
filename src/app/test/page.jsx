...
const FullScreenChatbot = () => {
  const [messages, setMessages] = useState([
    {
      ...
      type: "bot",
      content:
        "Namaste! What do you need Rainfall recharge or Ground water replenish rate or anything else I can help you with that?",
  ...
  const TypingIndicator = () => (
    <div
      className={`flex justify-start mb-6 animate-in slide-in-from-bottom-2 duration-300`}
    >
      <div className="flex items-end space-x-3 max-w-xs lg:max-w-2xl">
        ...
        <div className="flex flex-col">
          <div
            className={`p-4 rounded-2xl rounded-bl-md shadow-sm border ${
              isDarkMode
  ...
  const MessageBubble = ({ message }) => (
    <div
      ...
      } mb-6 animate-in slide-in-from-bottom-2 duration-300`}
    >
      <div
        className={`flex items-end space-x-3 max-w-xs lg:max-w-2xl ${
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <span
            ...
            } mt-2 px-1 ${message.type === "user" ? "text-right" : ""}`}
          >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        } backdrop-blur-md border-b px-6 py-4 flex items-center justify-between relative overflow-hidden`}
      >
      ...
      <div
        ...
        } backdrop-blur-md border-t px-6 py-6`}
      >
        <div className="max-w-4xl mx-auto">
          <div className="flex items-end space-x-4">
            <div
              className={`flex-1 min-h-[56px] max-h-40 ${
                isDarkMode
                  ? "bg-gray-700 border-gray-600"
                  : "bg-gray-50 border-gray-200"
              } rounded-2xl border focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 transition-all duration-200 relative overflow-hidden`}
            >
